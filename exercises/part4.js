...
console.log(spaceShuttle.name + " would tale " + spaceShuttle.getDaysToLocation(kilometersToMars) + " days to get to Mars.");
console.log(spaceShuttle.name + " would tale " + spaceShuttle.getDaysToLocation(kilometersToTheMoon) + " days to get to Moon.");
